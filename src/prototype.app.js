...
function App() {
  ...
  useEffect(() => {
	...
	if (decade) {
     ...
     // Figure out if movie.release_date is within decade
      // Some examples:
      // https://forums.asp.net/t/1840408.aspx?How+can+I+check+a+date+is+between+a+date+range+in+javascript
      // https://stackoverflow.com/questions/45452456/how-to-check-date-in-range-in-javascript
